...
- **Target cleanliness.** `--target` refuses dirty worktrees while planning and revalidates cleanliness immediately before teardown, so database cleanup never precedes the dirty-worktree refusal.
