...
CREATE UNIQUE INDEX "upload_intakes_source_path_live" ON "upload_intakes" USING btree ("context_source_id",lower("final_path")) WHERE "upload_intakes"."state" <> 'deleted';