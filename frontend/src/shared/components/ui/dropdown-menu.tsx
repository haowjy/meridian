...
function DropdownMenuCheckboxItem({
  ...
  return (
    <DropdownMenuPrimitive.CheckboxItem
      ...
      className={cn(
        "focus:bg-hover focus:text-foreground relative flex items-center gap-1 py-1.5 pr-2 pl-8 text-xs outline-none select-none data-[disabled]:pointer-events-none data-[disabled]:opacity-[--opacity-disabled] [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 rounded-sm transition-colors duration-[--duration-fast]",
        className
      )}
      checked={checked}
      {...props}
...
function DropdownMenuSubTrigger({
  ...
  return (
    <DropdownMenuPrimitive.SubTrigger
      ...
      data-inset={inset}
      className={cn(
        "focus:bg-hover focus:text-foreground data-[state=open]:bg-hover data-[state=open]:text-foreground [&_svg:not([class*='text-'])]:text-muted-foreground flex items-center gap-1 px-2 py-1.5 text-xs outline-none select-none data-[inset]:pl-8 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 rounded-sm transition-colors duration-[--duration-fast]",
        className
      )}
      {...props}
    >
