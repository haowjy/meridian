...
const expectedSuites = [
  ...
  "apps/server/server/domains/projects/new-chat-fallback-work.db.test.ts",
  ...
  "apps/server/server/lib/thread-creation.db.test.ts",
  ...
  "apps/server/server/domains/threads/adapters/drizzle/work-chat-feed-repository.db.test.ts",
  "apps/server/server/domains/threads/adapters/drizzle/thread-user-state-contention.db.test.ts",
  ...
  "apps/server/server/routes/api/projects/[projectId]/works/index.get.db.test.ts",
